      ...
      >
        ...
        <div className="absolute inset-0 z-0 bg-[#05070c]">
          <motion.div 
            ...
            // 🛑 اصلاح طلایی ۱: افزایش اوپاسیتی از 0.4 به 0.6 جهت درخشان و روشن‌تر شدن عکس کارخانه
          ...
          />
          {/* 🛑 اصلاح طلایی ۲: ملایم کردن اوورلی تیره وسط به via-industrialBlack/25 جهت وضوح بالاتر بک‌گراند */}
          <div className="absolute inset-0 bg-gradient-to-t from-industrialBlack via-industrialBlack/25 to-transparent" />
        </div>
